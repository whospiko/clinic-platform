...
export class CreateScheduleOverrideRequest {
  @ApiPropertyOptional({
    ...
    nullable: true,
    description:
      'Optional clinic ID. Use this when the override applies only to one clinic branch.',
  })
  @IsOptional()
  @IsUUID()
  ...
  @ApiProperty({
    ...
    description:
      'Type of schedule override, for example day off, custom working hours, or blocked time',
  })
  ...
  @ApiPropertyOptional({
    ...
    nullable: true,
    description:
      'Override start time in 24-hour HH:mm format. Required for partial-day override types.',
  })
  @IsOptional()
  ...
  @ApiPropertyOptional({
    ...
    nullable: true,
    description:
      'Override end time in 24-hour HH:mm format. Required for partial-day override types.',
  })
  @IsOptional()
  @Matches(/^([01]\d|2[0-3]):[0-5]\d$/)
  endTime?: string | null;
