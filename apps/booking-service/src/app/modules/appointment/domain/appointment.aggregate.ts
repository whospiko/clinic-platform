...
export class AppointmentAggregate {
  ...
  cancel(reason: string): void {
    ...
    this.addEvent(new AppointmentCancelledEvent(this.id, reason, new Date()));
  }
  ...
  complete(): void {
    ...
    this.addEvent(new AppointmentCompletedEvent(this.id, new Date()));
  }
