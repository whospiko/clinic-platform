...
export class CreateAppointmentHoldHandler
  implements
    ICommandHandler<CreateAppointmentHoldCommand, AppointmentHoldReadModel>
{
  constructor(
  ...
  async execute(
    command: CreateAppointmentHoldCommand,
    ...
    if (overlappingHolds.length > 0) {
      throw new ConflictException(
        'This appointment slot is already temporarily held.',
      );
    }
