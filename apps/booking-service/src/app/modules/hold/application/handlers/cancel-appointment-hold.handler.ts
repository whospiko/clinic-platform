...
export class CancelAppointmentHoldHandler
  implements
    ICommandHandler<CancelAppointmentHoldCommand, AppointmentHoldReadModel>
{
  constructor(
  ...
  async execute(
    command: CancelAppointmentHoldCommand,
    ...
    try {
      ...
      throw new ConflictException(
        error instanceof Error ? error.message : 'Cannot cancel hold.',
      );
    }
