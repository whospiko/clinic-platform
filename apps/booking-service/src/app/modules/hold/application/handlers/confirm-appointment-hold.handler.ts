...
export class ConfirmAppointmentHoldHandler
  implements
    ICommandHandler<ConfirmAppointmentHoldCommand, AppointmentHoldReadModel>
{
  constructor(
  ...
  async execute(
    command: ConfirmAppointmentHoldCommand,
    ...
    try {
      ...
      throw new ConflictException(
        error instanceof Error ? error.message : 'Cannot confirm hold.',
      );
    }
