...
export class ExpireAppointmentHoldHandler
  implements
    ICommandHandler<ExpireAppointmentHoldCommand, AppointmentHoldReadModel>
{
  constructor(
  ...
  async execute(
    command: ExpireAppointmentHoldCommand,
    ...
    try {
      ...
      throw new ConflictException(
        error instanceof Error ? error.message : 'Cannot expire hold.',
      );
    }
