...
export class AppointmentHoldController {
  ...
  async create(
    @Body() body: CreateAppointmentHoldRequest,
  ...
  async confirm(
    ...
    return this.commandBus.execute(
      new ConfirmAppointmentHoldCommand(id, body.appointmentId),
    );
  }
  ...
  @ApiOperation({
    ...
    description:
      'Cancels an active hold when patient leaves checkout or changes selected slot.',
  })
  @ApiOkResponse({
